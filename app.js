...
// Determine winner via explicit flag first, then by score comparison.
let win;
...
return `<a class="schedule-item" href="${link}" target="_blank" rel="noopener"> <div class="schedule-date"><span class="month">${month}</span><span class="day">${day}</span></div> <div class="schedule-middle"> <div class="schedule-matchup">${matchup}</div> <div class="schedule-meta">${meta}</div> </div> ${result} </a>`;
}
